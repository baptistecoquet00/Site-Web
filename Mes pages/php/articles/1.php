...
<?php 
		include_once "../euh.php";
		$req = mysqli_query($con, 'SELECT * FROM produit WHERE id = 1');
		while($row=mysqli_fetch_assoc($req)){

		
		?>
		<form action="../ajouter_panier.php?id=<?=$row['id']?>" method="post">
			...
			<div class="boutton">
				...
				<input type="submit" name="add_to_cart" value="Ajouter au panier" class="panier2">
			</div>
			<div class="Quantite">
				<h4>Quantité</h4>
